package NP.NPKolokvium1.lab1NP.zad1;
...
final class IntegerArray {
    ...
    public IntegerArray(int[] numArray) {
        this.numArray = Arrays.copyOf(numArray, numArray.length);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(numArray, that.numArray);
    }

    @Override
    public int hashCode() {
        return Arrays.hashCode(numArray);
    }
    ...
    public IntegerArray getSorted() {
        return new IntegerArray(Arrays.stream(numArray).sorted().toArray());
    }

    public IntegerArray concat(IntegerArray ia) {
        int[] array = IntStream.concat(Arrays.stream(this.numArray), Arrays.stream(ia.numArray)).toArray();
