package APS.APSKolokvium2.lab8APS.zad1;
...
public class WindowsExplorer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SLLNode<String> node;
        SLLNode<String> parent=tree.root;

        for (int l = 0; l < N; l++) {
            String[]words=commands[l].split("\\s+");
            switch (words[0]){
                case "CREATE":
                    tree.addChild(parent,words[1]);
                    break;
                case "OPEN":
                    node=parent.firstChild;
                    while(node!=null && !node.element.equals(words[1])){
                        node=node.sibling;
                    }
                    if(node!=null){
                        parent=node;
                    ...
                    break;
                case "DELETE":
                    SLLNode<String> element=parent.firstChild;
                    while(element!=null && !element.element.equals(words[1])){
