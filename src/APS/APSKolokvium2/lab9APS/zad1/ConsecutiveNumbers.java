package APS.APSKolokvium2.lab9APS.zad1;
...
public class ConsecutiveNumbers {
    ...
    public static boolean largerByTwo(Stack <BNode<Integer>> treeStack){
        BNode<Integer>current=null;
        BNode<Integer>previous=null;

        while(!treeStack.isEmpty()){
            previous = current;
            current=treeStack.pop();
            if(previous!=null && current.info - previous.info!=2){
                return false;
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // vasiot kod ovde
        Stack<BNode<Integer>>treeStack=new Stack<>();
        treeStack.push(tree.root);
        System.out.println(largerByTwo(treeStack));
    }
